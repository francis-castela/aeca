...
- Executar `./ferramentas/scripts/validar-site.ps1`.
- Executar `./ferramentas/scripts/auditar-performance.ps1`.
- Executar `./ferramentas/scripts/verificar-links.ps1`.
- Executar `./ferramentas/scripts/verificar-seo-basico.ps1`.
- Executar `./ferramentas/scripts/verificar-acessibilidade.ps1`.
- Executar `./ferramentas/scripts/verificar-assets-referenciados.ps1`.
- Executar `./ferramentas/scripts/verificar-ortografia.ps1`.
